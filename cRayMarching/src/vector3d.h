...
public:
    ...
    // abs
    //------------------------------------------------------------------
    // Returns a Vector whos x, y and z components are positive
    //------------------------------------------------------------------
    friend Vector3D abs (const Vector3D &v1, const float f);
    //------------------------------------------------------------------
    // Min
    //------------------------------------------------------------------
    ...
    friend Vector3D min (const Vector3D &v1, const float f);
    //------------------------------------------------------------------
    // Max
    //------------------------------------------------------------------
    ...
    friend Vector3D max (const Vector3D &v1, const float f);
    //------------------------------------------------------------------
    // DistanceBetween
    //------------------------------------------------------------------
...
inline Vector3D abs(const Vector3D &v1){
    return Vector3D(fabs(v1.x),
                    fabs(v1.y),
                    fabs(v1.z));
}
...
inline Vector3D min(const Vector3D &v1, const float f){
    return Vector3D(fmin(v1.x, f),
                    fmin(v1.y, f),
                    fmin(v1.z, f));
}

inline Vector3D max(const Vector3D &v1, const float f){
    return Vector3D(fmax(v1.x, f),
                    fmax(v1.y, f),
                    fmax(v1.z, f));
}
